...
void startQuiz()
{
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        case 1:
            ...
            {
                printf("Wrong! The correct answer is b. 1972\n\n");
                printf("---------------------------\n");
            }
            break;
        ...
        case 3:
            ...
            {
                printf("Wrong! The correct answer is b. .c\n\n");
                printf("---------------------------\n");
            }
            break;
        ...
        case 4:
            ...
            {
                printf("Wrong! The correct answer is d. string\n");
                printf("---------------------------\n");
            }
            break;
        ...
        case 5:
            ...
            {
                printf("Wrong! The correct answer is d. 1name\n");
                printf("---------------------------\n");
            }
            break;
        ...
        case 6:
            ...
            {
                printf("Wrong! The correct answer is c. 1function\n");
                printf("---------------------------\n");
            }
            break;
        ...
        case 7:
            ...
            {
                printf("Wrong! The correct answer is c. string.c\n");
                printf("---------------------------\n");
            }
            break;
        ...
        case 8:
            ...
            {
                printf("Wrong! The correct answer is d. x\n");
                printf("---------------------------\n");
            }
            break;
        ...
        case 9:
            ...
            {
                printf("Wrong! The correct answer is d. loop\n");
            }
            break;
        ...
        case 10:
            ...
            {
                printf("Wrong! The correct answer is c. string\n");
                printf("---------------------------\n");
            }
            break;
        ...
        case 11:
            ...
            {
                printf("Wrong! The correct answer is b. scan()\n");
                printf("---------------------------\n");
            }
            break;
        ...
        case 12:
            ...
            {
                printf("Wrong! The correct answer is c. .h\n");
                printf("---------------------------\n");
            }
            break;
        ...
        case 13:
            ...
            {
                printf("Wrong! The correct answer is a. C++\n");
                printf("---------------------------\n");
            }
            break;
        ...
        case 15:
            ...
            {
                printf("Wrong! The correct answer is a. 123\n");
                printf("---------------------------\n");
            }
            break;
        ...
        case 16:
            ...
            {
                printf("Wrong!\n The correct answer is b. 123.45");
                printf("---------------------------\n");
            }
            break;
    ...
    if (score == 100)
        ...
        printf("\nDecent!, But This Can Be Improved.");
    else
        printf("\nYou Failed The Quiz :(, Learn More And Try Again\n");
    printf("----------------------------\n\n");
